...
class PsychiatristLanding extends React.Component {
...
const WrappedPsychiatristPsychiatristLanding = Form.create({name: "psychiatristLanding"})(
    PsychiatristLanding
);

export default WrappedPsychiatristPsychiatristLanding;
